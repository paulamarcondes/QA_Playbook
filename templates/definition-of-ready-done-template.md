...
Use this template to define clear, practical quality gates for stories, tasks, features, integrations, and releases.
...
| Risk level | The story has a risk classification: Low / Medium / High. |  |
...
- The expected behavior depends on assumptions nobody confirmed.
...
Definition of Ready protects the team from unclear work.

Definition of Done protects the user, the product, and the business from incomplete delivery.
